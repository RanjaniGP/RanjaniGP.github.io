...
<meta content="Robot Framework 3.0.3 (Python 2.7.9 on win32)" name="Generator">
...
<script type="text/javascript">
libdoc = {"all_tags":[],"contains_tags":false,"doc":"<p>Library for comparison of files in different formats.\x3c/p>\n<p>This library is part of the ${fusionresource}\x3c/p>","generated":"2018-04-30 13:23:26","inits":[],"keywords":[{"args":["baseline_file","app_file","delimiter=,","skip_columns_names=None","sort_columns_names=None","key_columns_names=None","number_of_valid_digits=None"],"doc":"<p>Compares csv files and copy it to runtime output_dir. By default delimiter is set to ','.\x3c/p>\n<table border=\"1\">\n<tr>\n<td>Mx Compare Csv Files\x3c/td>\n<td>${CURDIR}\\\\baseline.csv\x3c/td>\n<td>${CURDIR}\\\\app.csv\x3c/td>\n<td>\x3c/td>\n\x3c/tr>\n<tr>\n<td>Mx Compare Csv Files\x3c/td>\n<td>${CURDIR}\\\\baseline.csv\x3c/td>\n<td>${CURDIR}\\\\app.csv\x3c/td>\n<td>delimiter=';'\x3c/td>\n\x3c/tr>\n\x3c/table>\n<p>To use skip columns or sort functionalities passing list arguments is required.\x3c/p>\n<table border=\"1\">\n<tr>\n<td>Mx Compare Csv Files\x3c/td>\n<td>${CURDIR}/baseline_key_column.csv\x3c/td>\n<td>${CURDIR}/app_key_column.csv\x3c/td>\n<td>sort_columns_names=@{Sort Colums}\x3c/td>\n<td>\x3c/td>\n\x3c/tr>\n<tr>\n<td>Mx Compare Csv Files\x3c/td>\n<td>${CURDIR}/baseline_key_column.csv\x3c/td>\n<td>${CURDIR}/app_key_column.csv\x3c/td>\n<td>skip_columns_names=@{Skip Colums}\x3c/td>\n<td>\x3c/td>\n\x3c/tr>\n<tr>\n<td>Mx Compare Csv Files\x3c/td>\n<td>${CURDIR}/baseline_key_column.csv\x3c/td>\n<td>${CURDIR}/app_key_column.csv\x3c/td>\n<td>key_columns_names=@{Key Colums}\x3c/td>\n<td>\x3c/td>\n\x3c/tr>\n<tr>\n<td>Mx Compare Csv Files\x3c/td>\n<td>${CURDIR}/baseline_key_column.csv\x3c/td>\n<td>${CURDIR}/app_key_column.csv\x3c/td>\n<td>skip_columns_names=@{Skip Colums}\x3c/td>\n<td>sort_column_names=@{Sort Colums}\x3c/td>\n\x3c/tr>\n<tr>\n<td>Mx Compare Csv Files\x3c/td>\n<td>${CURDIR}/baseline_key_column.csv\x3c/td>\n<td>${CURDIR}/app_key_column.csv\x3c/td>\n<td>skip_columns_names=@{Skip Colums}\x3c/td>\n<td>sort_column_names=@{Sort Colums}\x3c/td>\n\x3c/tr>\n\x3c/table>\n<p>For the current version it is possibly to sort values alphabetically only.\x3c/p>","matched":true,"name":"Mx Compare Csv Files","shortdoc":"Compares csv files and copy it to runtime output_dir. By default delimiter is set to ','.","tags":[]},{"args":["data1","data2","output_file=None","is_data1_file=False","is_data2_file=False","ignored_keys=None","nb_of_valid_decimal_places=100"],"doc":"<p>Compares two jsons. If is_data1_file=True the contents are loaded from file pointed by 'data1'. Otherwise it's treated as JSON string. Same for is_data2_file. Keyword raises error if there are differences in files. output_file parameter is obsolete.\x3c/p>","matched":true,"name":"Mx Compare Json Data","shortdoc":"Compares two jsons.","tags":[]},{"args":["json_baseline_file","json_data","ignored_keys=None","nb_of_valid_decimal_places=100","nb_of_digit_after_decimal=0"],"doc":"","matched":true,"name":"Mx Compare Json With Baseline File","shortdoc":"","tags":[]},{"args":["app_file","baseline_file","sheet_name="],"doc":"<p>Compare 2 xls files.\x3c/p>\n<p>The features of this keyword are:\x3c/p>\n<ul>\n<li>comparison of the content of 2 files, 1 file is given as baseline and the second one is generated during a test (export of data from a component)\x3c/li>\n<li>currently we only need to compare excel files, but the solution should allow flexibility in the future\x3c/li>\n<li>date format and number format should be checked 1:1\x3c/li>\n\x3c/ul>\n<p>Missing row is marked as \"NO DATA\". Empty cell is considered as data with no characters. Two empty cells are equal and will return PASS.\x3c/p>","matched":true,"name":"Mx Compare Xls Files","shortdoc":"Compare 2 xls files. ","tags":[]},{"args":["baselinexml","responsexml","ignored_keys=None","nb_of_valid_decimal_places=100"],"doc":"<p>comparison of the content of 2 xmls(baselinexml and responsexml), 1 file is given as baseline and the second one is generated during a test ignored_keys - keys to be ignored in comparison\x3c/p>","matched":true,"name":"Mx Compare Xml With Baseline File","shortdoc":"comparison of the content of 2 xmls(baselinexml and responsexml), 1 file is given as baseline and the second one is generated during a test","tags":[]},{"args":["json_file","key_to_sort_by","*path_to_list"],"doc":"<p>Sorting a list by a 'key_to_sort_by'. path_to_the list in the 'json_file' should be given as a list. Example of usage:\x3c/p>\n<table border=\"1\">\n<tr>\n<td>${sorted_out}\x3c/td>\n<td>Mx json inner list sort\x3c/td>\n<td>unsorted.json\x3c/td>\n<td>attributes\x3c/td>\n<td>rows\x3c/td>\n\x3c/tr>\n\x3c/table>","matched":true,"name":"Mx Json Inner List Sort","shortdoc":"Sorting a list by a 'key_to_sort_by'. path_to_the list in the 'json_file' should be given as a list.","tags":[]},{"args":["locator","baseline_filepath"],"doc":"<table border=\"1\">\n<tr>\n<td>Usage\x3c/td>\n\x3c/tr>\n\x3c/table>\n<p>It compares the list creates from the application with the baseline list.\x3c/p>\n<table border=\"1\">\n<tr>\n<td>Arguments\x3c/td>\n\x3c/tr>\n\x3c/table>\n<p>'locator' = locator of the list\x3c/p>\n<p>'baseline_filepath' = Baseline file location\x3c/p>","matched":true,"name":"Mx List Baseline Comparator","shortdoc":"| Usage |","tags":[]},{"args":["unsortedxml","sortedxml","sort_key_tag=None","root_xpath=None","reverse=False"],"doc":"<p>Sorting the xml based on the unique tag and root xpath given\x3c/p>","matched":true,"name":"Mx Xml Sort","shortdoc":"Sorting the xml based on the unique tag and root xpath given","tags":[]}],"name":"BaselineComparator","named_args":true,"scope":"test case","version":""};
</script>
<title></title>
</head>
<body>
